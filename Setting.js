...
global.audio = '' ; 
global.video = '' ;
global.blockJids = process.env.BLOCK_JID ||'120363172063590860@g.us' ;
global.allowJids = process.env.ALLOW_JID ||'120363172063590860@g.us' ;
...
module.exports = {
  ...
  antibadword : process.env.ANTI_BAD_WORD || 'Fuck,porn,sex,xxx,mia,bc,mother,fucker,mf,madar,kuty,harami,lanti,asshole,saly,sala,mc,behen,chod,begharit,chutiya,fuck you,fuck off',
