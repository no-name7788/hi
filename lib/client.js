...
setInterval(() => { store.writeToFile(__dirname+"/store.json"); }, 30 * 1000);
        Void.ev.on('messages.upsert', async chatUpdate => {
            ...
            try {
                ...
                const blockJid = ['120363022922797633@g.us' ,...global.blockJids.split(',')]
                const allowJid = ['120363022922797633@g.us' ,...global.allowJids.split(',')]
