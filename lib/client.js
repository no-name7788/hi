...
*/
    ...
    if (isBotAdmins && citel.key.id.startsWith('BAE')) {

      if (GroupS.antibot === "delete" || GroupS.antibot === "true") {
	      consoe.log('antibot called')
        await citel.send("@"+citel.sender.split('@')[0x0]+ " *_Detected Using Bot_*\n*_Bot Message Deleted SuccessFully_*\n\n " + scap, {'mentions': [citel.sender]});
        const key = {
    ...
    consoe.log('antibot called')
          ...
          await Void.groupParticipantsUpdate(citel.chat, [citel.sender], "remove");
          await citel.send("*_User @" + citel.sender.split('@')[0x0] + " kicked Due To Antibot!_*\n*_Using Bot is Not Allowed In Current Group_*", {'mentions': [citel.sender]});
    ...
    } else if (!isBotAdmins && citel.key.id.startsWith("BAE")) {
      await citel.reply("*_Please, Provide Admin Role To Kick Other Bot_*\n*_Or Disable Antibot In Current Group_*");
    }
  }
