...
┃✗ *•𝙼𝙾𝙳𝙴•* ${name.WORKTYPE}
┃✗ *•𝚃𝙾𝚃𝙰𝙻-𝙿𝙻𝚄𝙶𝙸𝙽𝚂•* ${events.commands.length}
...
{                        
    Msg  +=`┏━━⟪⟪ 🅼♥︎❚❚♥︎🆉 ⟫━⦿                
┃✗『 𝐍𝐞𝐰 𝐔𝐩𝐝𝐚𝐭𝐞-𝐑𝐞𝐥𝐞𝐚𝐬𝐞𝐝 』
┃✗ *_Hey ${name.ownername} Your Bot Have_*
┃✗ *_A New Update_*
